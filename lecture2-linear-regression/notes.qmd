...
Here, $w_i$ and $b$ are constants that define the particular function. We will refer to these as the **parameters** of the function. We can also write this using a dot-product between our input $\mathbf{x}$ and parameter vector $\mathbf{w}$ as:
